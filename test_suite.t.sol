...
contract test_suiteTest is Test
{
    ...
    function testLibraryConsistent() public noGasMetering
    {
        ...
        // ***WARNING***
        // current function does not succeed for
        // "G2_public_keys"[0] =
        /*{
            "x":
            {
                "c0": "17267733413650230193222922153445270939806798115927372379982088744205711261095",
                "c1": "15854078293592491502266924041959310439667723715867379089286498124550238459007"
            },
            "y":
            {
                "c0": "18774499809907314868909550768741913920297412678837442223181886738088894724467",
                "c1": "1544166576206462055037343427328113268080923218411858629102632928910719259953"
            }
        }
    ...
    function testLibConsistentTwo() public noGasMetering
    {
        ...
        // What's odd is that this function DOES pass
        uint256[2] memory pt = bls.hashToPoint(bytes(domain), bytes("Hello world!"));
        for(uint256 i = 0; i < 1000; i++)
        {
            uint[] memory iq = g1_signatures[i];
